...
<?php
 ...
 $Id_PCIcIdiomas = $_POST["Id_PCIcIdiomas"]; 
 $Habla = $_POST["Habla"];
 $Lee = $_POST["Lee"];
...
$sql = "INSERT INTO pcididiomas  (Id_PCIcIdiomas, Id_PCIdDatosPersonales, Habla, Lee, Escribe, Observaciones, Id_PCIdUsuarios, IP_User, Operacion )
	                     VALUES ($Id_PCIcIdiomas, $Id_PCIdDatosPersonales, '$Habla', '$Lee', '$Escribe', '$Observaciones', $Id_PCIdUsuarios , '$IP_User', '$Operacion')";
