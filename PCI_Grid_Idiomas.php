...
$cadenaSQL = "SELECT * FROM vista_pcididiomas_pcicidiomas  WHERE Id_PCIdDatosPersonales =  $Id_PCIdDatosPersonales";
...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" background="ImagenesVidanta/LOGOLOCO03(1000x400)(SinFondo_10opacidad).png">
  <HR> 
	    ...
	    <table width="727" border="1"  align="center" cellpadding="2" cellspacing="2" >
		    ...
		    <tr bgcolor="#1C83BD">
			<td colspan="4" align="center"> <strong> RESULTADO DE BUSQUEDA </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="PCI_Alta_Idiomas.php?Id_PCIdDatosPersonales=<?php echo $Id_PCIdDatosPersonales;?>" >AGREGAR REGISTRO</a>
			</tr>      
            <tr bgcolor="#1C83BD">
			    <td align="center" >Acci&oacute;n</td>
                <td align="center" >Idioma</td>
				<td align="center" >Habla</td>
            ...
            <?php
                 ...
                 $cadenaSQL_Vista = " SELECT * FROM vista_pcididiomas_pcicidiomas  WHERE Id_PCIdDatosPersonales =  $Id_PCIdDatosPersonales";
			...
			<tr>
				...
				<td align="center"><?php echo $registro_Vista['PCIcIdiomas'];?></td> 
				<td align="center"><?php echo $registro_Vista['Habla']; ?></td>
				<td align="center"><?php echo $registro_Vista['Lee'];?></td>
